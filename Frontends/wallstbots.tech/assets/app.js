...
function renderGetYours() {
  ...
  $('app').innerHTML =
    ...
    + '<p>Build, test, and refine your portfolio with a market research tool built for the modern trader. Track up to 50 stocks simultaneously with daily technical analysis — Buy/Sell/Hold signals analyzed by AI. Plus, never miss a beat with personalized sector news delivered straight to your dashboard. <strong style="color:var(--blue)">Wall St. Bots</strong> lets you master the market without the risk.</p></div></section>'
    ...
    + '<input type="hidden" name="item_name" value="wallstbots.tech Custom Tracker - Annual">'
    ...
    + '<p style="color:var(--muted);font-size:13px;font-style:italic;margin:0">Built by an operator who runs the same system on his own portfolio. Cancel anytime from your PayPal account. Questions? <a href="mailto:info@wallstbots.tech" style="color:var(--blue)">info@wallstbots.tech</a></p></div>';
}

function renderThanks() {
  $('app').innerHTML = '<section class="hero"><div class="hero-content">'
    + '<h1>You\'re in. 🎉</h1>'
    + '<p>Your Wall St. Bots tracker will be live within 24 hours. Check your email for your private dashboard link.</p>'
