...
set "SUPABASE_URL=%SUPABASE_URL%" & set "SUPABASE_SERVICE_ROLE_KEY=%SUPABASE_SERVICE_ROLE_KEY%" & set "SUPABASE_ANON_KEY=%SUPABASE_ANON_KEY%" & set "JWT_SECRET=%JWT_SECRET%" & set "DATABASE_URL=%DATABASE_URL%" & set "PAYPAL_CLIENT_ID=%PAYPAL_CLIENT_ID%" & set "PAYPAL_CLIENT_SECRET=%PAYPAL_CLIENT_SECRET%" & set "INTERNAL_API_KEY=%INTERNAL_API_KEY%"
